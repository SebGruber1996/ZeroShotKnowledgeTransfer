...
--KL_temperature 1 \
--AT_beta 0 \
--pretrained_models_path ~/Repositories/master_thesis_sg/results/MiniImagenet/batch_size_4_meta_epochs_100_max_batches_100_max_batches_val_100_seed_123/'teacher_model_2020-07-03 14:25:21.562470.th' \
